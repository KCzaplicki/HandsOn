Console.WriteLine("Console application with Redis and RedLock.net - Service A\r\n");
...
{
    // Lock resource
    Console.WriteLine($"[ServiceA] Locking resource '{lockKey}'");
    ...
    if (redLock.IsAcquired)
    {
        ...
        // Release lock
        Console.WriteLine($"[ServiceA] Releasing lock for resource '{lockKey}'");
